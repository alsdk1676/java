...
//	누가썼는지, 무슨 내용을 썼는지 읽어오기
	public ServerThread2(Socket socket, List<PrintWriter> outputList) { 
		this.socket = socket;
...
class ServerInputThread2 extends Thread {
	private final List<PrintWriter> outputList;
	
	public ServerInputThread2(List<PrintWriter> outputList) {
		this.outputList = outputList;
	}
