...
//	누가썼는지, 무슨 내용을 썼는지 읽어오기
	public ServerThread3(Socket socket, List<PrintWriter> outputList) { 
		this.socket = socket;
...
class ServerInputThread3 extends Thread {
	private final List<PrintWriter> outputList;
	
	public ServerInputThread3(List<PrintWriter> outputList) {
		this.outputList = outputList;
	}
