...
public class Lotto {
    ...
    public void checkLotto(Member member) {
        int count = count(member.getInputNumbers());  // lottoNumbers → inputNumbers
    ...
    // 일치하는 개수 세기
    int count(int[] inputNumbers) {  // lottoNumbers → inputNumbers
        int count = 0;
        for (int num : inputNumbers) {
            for (int winNum : luckyNumberArray) {
                if (num == winNum) {
                    count++;
                }
            }
    ...
    public static void main(String[] args) {
        ...
        int[] inputNumbers = new int[6];  // lottoNumbers → inputNumbers
        int num = 0;
...
class Member {
    private String job;
    private int[] inputNumbers;  // lottoNumbers → inputNumbers
    ...
    public int[] getInputNumbers() {  // lottoNumbers → inputNumbers
        return inputNumbers;
    }

    public void setInputNumbers(int[] inputNumbers) {  // lottoNumbers → inputNumbers
        this.inputNumbers = inputNumbers;
    }
